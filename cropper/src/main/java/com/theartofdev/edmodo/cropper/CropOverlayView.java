...
public class CropOverlayView extends View {
    ...
    private Paint mCornerThumbPaint;
     ...
     * Corner thumb radius
     */
    private float mBorderCornerThumbRadius;
    ...
    public void setInitialAttributeValues(CropImageOptions options) {
        ...
        mCornerThumbPaint = getCornerThumbPaint(options.borderLineColor);
        mBorderCornerThumbRadius = options.borderCornerThumbRadius;
    ...
    private void drawCorners(Canvas canvas) {
        if (mBorderCornerPaint != null) {
            ...
            float offset = mBorderPaint.getStrokeWidth() + mBorderCornerThumbRadius;

            drawThumb(canvas, rect.left + offset, rect.top + offset);
            drawThumb(canvas, rect.right - offset, rect.top + offset);
            drawThumb(canvas, rect.left + offset, rect.bottom - offset);
            drawThumb(canvas, rect.right - offset, rect.bottom - offset);
        }
    }

    private void drawThumb(Canvas canvas, float centerX, float centerY) {
        float radius = mBorderCornerThumbRadius;
        mDrawRect.set(centerX - radius, centerY - radius,
                centerX + radius, centerY + radius);
        canvas.drawOval(mDrawRect, mCornerThumbPaint);
    }

    private static Paint getCornerThumbPaint(int color) {
