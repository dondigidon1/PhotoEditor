...
public class CropImageOptions implements Parcelable {
    ...
    /**
     * Radius for corner thumb.
     */
    public float borderCornerThumbRadius;
    ...
    public CropImageOptions() {
        ...
        borderCornerThumbRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 9, dm);
    ...
    protected CropImageOptions(Parcel in) {
        ...
        borderCornerThumbRadius = in.readFloat();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeFloat(borderCornerThumbRadius);
